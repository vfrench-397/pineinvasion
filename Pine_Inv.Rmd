...
```{r echo=FALSE, fig.cap="**Figure X. Scatterplot of genera significance for %N vs. genera midnightblue module membership.** Each point represents one genus in the module. Module membership in the midnightblue module for a given genus is a measure of the correlation of the module eigengene and the genus abundance profile. A tighter positive correlation between module membership and genera significance indicates higher significance of the module. cor is the correlation value, and p indicates the significance of the correlation."}
...
In these heatmaps, we can see that the abundance of midnightblue module genera in a sample does not correspond as well with high N as did the yellow module genera with low P. However, we still see some variation in the abundance of genera in the midnight blue module with forest type, with the invaded forest at the second site having higher abundances of midnightblue module genera, indicating that the fungal communities change with pine invasion.
