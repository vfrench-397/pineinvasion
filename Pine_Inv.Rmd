...
```
**Figure X:** Barplot of taxa abundance by forest type. The x-axis displays the categorical variables of forest type. The y-axis is total abundance of taxonomic class. From this figure we can conclude in the pine invaded forests there is an overall trend towards both a lower total abundance of taxa and a lower diversity of taxa relative to the other two forest types. 
...
```
**Figure X. Dendrogram and module colors.** Each leaf of the tree corresponds to a genus, and branches grouping together densely are genera that frequently occur together. The colors on the Dynamic Tree Cut band correspond to the module groupings of genera. No modules have been merged. 
...
```
**Figure X. Tree clustering of module eigen abundances based on similarity.** Each branch of the tree represents a module. The red line shows the height at which we merged modules, which was 0.7.
...
**Figure X. Barplot of genera in the yellow module vs. their kMEs for the module.** Increasing kME indicates that the genus fits better into the module.
...
```{r echo=FALSE, fig.cap="**Figure X. Scatterplot of genera significance for %N vs. genera module membership in the midnightblue module.** Each point represents one genus in the module. Module membership in the midnightblue module for a given genus is a measure of the correlation of the module eigengene and the genus abundance profile. A tighter positive correlation between module membership and genera significance indicates higher significance of the module. cor is the correlation value, and p indicates the significance of the correlation."}
knitr::include_graphics(path.expand('/project/bi594/Pine_invasion/Figures/scatterplot_midnightblue.png'))
```

The plot of kME by genera for the midnightblue module shows which genera are in the module and how well they belong. 


```{r echo=FALSE, fig.cap="**Figure X. Barplot of genera in the midnightblue module vs. their kMEs for the module.** Increasing kME indicates that the genus fits better into the module."}
...
```{r echo=FALSE, fig.cap="**Figure X. Heatmap of genera abundances in each sample in the midnightblue module and eigengene abundance barplot.** Columns of the heatmap represent samples and rows represent each genus in the midnightblue module. Red indicates higher abundance of a genus and light green represents lower abundance. Higher bars in the barplot indicate higher abundances of genera in the midnightblue module in a given sample. PL samples are from pine plantations, UN samples are from uninvaded eucalypt forests adjacent to invaded forests, and INV are from pine-invaded eucalypt forests."}
knitr::include_graphics(path.expand('/project/bi594/Pine_invasion/Figures/abund_heatmap_midnightblue.png'))
```

```{r echo=FALSE, fig.cap="**Figure X. Heatmap of genera abundances in each sample in the midnightblue module and barplot of soil %N.** Columns of the heatmap represent samples and rows represent each genus in the midnightblue module. Red indicates higher abundance of a genus and light green represents lower abundance. Increasing values on the y-axis of the barplot indicate more total N in a soil sample. PL samples are from pine plantations, UN samples are from uninvaded eucalypt forests adjacent to invaded forests, and INV are from pine-invaded eucalypt forests."}
...
```{r echo=FALSE, fig.cap="**Figure X. Scatterplot of genera significance for %C vs. genera module membership in the  midnightblue module.** Each point represents one genus in the module. Module membership in the midnightblue module for a given genus is a measure of the correlation of the module eigengene and the genus abundance profile. A tighter positive correlation between module membership and genera significance indicates higher significance of the module. cor is the correlation value, and p indicates the significance of the correlation."}
